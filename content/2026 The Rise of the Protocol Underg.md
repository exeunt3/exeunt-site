---
title: "2026: The Rise of the Protocol Underground: LLMs provide the communications infrastructure for a reality coup"
publishDate: Jan 7, 2026
---

## 2026: The Rise of the Protocol Underground
### LLMs provide the communications infrastructure for a reality coup  

---
"So, in the attributes with which I’m not familiar, whose names I can’t even say, since there’s an infinity of them, there are other manners of being. There, there is the whole domain of a broad Spinozist science fiction, of what’s happening in the other attributes that we do not know."
-**Gilles Deleuze**, *[Spinoza: The Velocities of Thought](https://deleuze.cla.purdue.edu/lecture/lecture-02/), December 2, 1980*

---

Open protocols, we whispered. The key is open protocols. Software stacks, bike repair zines, intercropping strategies. [Microsolidarity](https://www.microsolidarity.cc) protocols, BDSM rope tying methods; how to throw a rave, how to build a backyard sauna, how to make a vegan peach pie. *Protocolize everything*.

2023 was the year of protocols, and while Ethereum Foundation’s successful [Summer of Protocols](https://summerofprotocols.com) project was carrying along, our scene [1] had convergently developed our own interest in a distinct form we called [**open protocols**](https://substack.com/@exeunteth/note/c-194597787). These protocols were not primarily web-based, though their recognition as a political-economic-epistemic force was certainly occasioned by the free software movement and its descendants. What they staged in their retroactive lineage (going back to the early middle ages and beyond) was a binary, an interpretation of technological affordances under the simple rubric of the underground: *Is this a technology of freedom, or a technology of control?*
...
For open protocols, this reconstitution is a relentless and perpetual process. 
They operate with a total lack of fealty to their progenitors, forever remaining memetically open before the surround. Like McKenna’s [self-transforming machine elves](https://www.monsterchildren.com/articles/what-are-the-machine-elves), they forge splintering paths through the many adventures of the social, operating with a queer and autonomous charisma as they enact new scenarios to extend themselves. The contingencies of memetic circulation give birth to wild new species of application, and the whole time no one is in control. They are creatures of chance, necessity, and ferocious empirical will.
...
What do we mean by spaces here? Let's turn to Michael Levin, whose lab work in cancer research probably has more to say about the future of technology than all the tech billionaires [a presidential inauguration could fit](https://www.bloomberg.com/news/articles/2025-01-20/billionaires-worth-1-3-trillion-embrace-trump-at-inauguration) put together: 
...
There is another latent space for ethnographic and phenomenological discovery: the space of possible social configurations, heretofore discouraged by institutional incentives or complacency dynamics. This space is considerably more advanced in terms of mapping, with such texts as Graeber and Wengrow’s [The Dawn of Everything](https://blackbooksdotpub.wordpress.com/wp-content/uploads/2021/10/david-graeber-david-wengrow-the-dawn-of-everything_-a-new-history-of-humanity-farrar-straus-and-giroux-2021.pdf), Graeber’s earlier ethnography on [Direct Action](https://theanarchistlibrary.org/mirror/d/dg/david-graeber-direct-action.pdf), Elinor Ostrom’s prolific fieldwork and others who have made use of her [IAD model](https://en.wikipedia.org/wiki/Institutional_analysis_and_development_framework), the work of anarchist researchers and cultural outposts like [c4ss](https://c4ss.org) and Crimethinc as well as Nathan Schneider and the [Media Economies Design Lab](https://www.colorado.edu/lab/medlab/), [Metagov](https://metagov.org), and mor. They represent new avenues of collective experience, new subjectivities with experiential horizons of their own. 
...
[5] With the important exception of drugs and certain areas in the purview of [psychonautwiki](https://psychonautwiki.org/wiki/Main_Page), both of which are crucial extitutions and inspirational for this essay. 
